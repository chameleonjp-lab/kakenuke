...
export const ENEMIES: Record<string, EnemyDef> = {
  ...
  BIRD_BLACK: { id: "BIRD_BLACK", color: "black", hp: 1, speed: 0.75, behavior: "straight", radius: 16, width: 40, height: 30, shape: "bird", score: 25 },
  BIRD_ORANGE: { id: "BIRD_ORANGE", color: "orange", hp: 1, speed: 0.75, behavior: "homing", radius: 16, width: 40, height: 30, shape: "bird", score: 35 },
